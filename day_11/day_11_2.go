...
func main() {
	// Steps, Elevator, SrG, SrC, PuG, PuC, RuG, RuC, TmG, TmC, CmG, Cmc, ElG, ElC, DlG, DlC
	initial_state := []int{0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 2, 2, 1, 1, 1, 1}

	target_state := []int{4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}
